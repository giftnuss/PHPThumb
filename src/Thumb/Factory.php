 ...
 */
require_once 'Thumb/Model.php';
/**
 * Include the GdThumb Class
 */
require_once 'Thumb/Img/Gd.php';
...
class Thumb_Factory
{
	...
	public static function create ($filename = null, $options = array(), $isDataStream = false)
	{
		...
		(
			// 'imagick'	=> 'Thumb_Img_Imagick', -- TODO
			'gd' 		=> 'Thumb_Img_Gd'
		);

		// grab an instance of PhpThumb
		$pt = Thumb_Model::getInstance();
		// load the plugins
...
Thumb_Factory::$pluginPath = dirname(__FILE__) . '/Plugin';
